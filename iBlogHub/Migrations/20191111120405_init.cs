        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SocialProfiles_AspNetUsers_AppUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookmarks_Posts_PostsId",
                        column: x => x.PostsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentStatus = table.Column<int>(nullable: false),
                    CommentParent = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostMedias_Posts_PostsId",
                        column: x => x.PostsId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagsPostsRelations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TagsPostsRelations_Posts_PostsId",
                        column: x => x.PostsId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TagsPostsRelations_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SocialProfiles_AppUsersId",
                table: "SocialProfiles",
                column: "AppUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_TagsPostsRelations_PostsId",
                table: "TagsPostsRelations",
                column: "PostsId");

            migrationBuilder.CreateIndex(
                name: "IX_TagsPostsRelations_TagsId",
                table: "TagsPostsRelations",
                column: "TagsId");
        }
