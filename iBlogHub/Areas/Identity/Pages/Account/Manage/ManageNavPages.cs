...
namespace iBlogHub.Areas.Identity.Pages.Account.Manage
{
    public static class ManageNavPages
    {
        ...
        public static string MyStories => "MyStories";
        ...
        public static string MyStoriesNavClass(ViewContext viewContext) => PageNavClass(viewContext, MyStories);
        ...
        private static string PageNavClass(ViewContext viewContext, string page)
        {
            ...
            return string.Equals(activePage, page, StringComparison.OrdinalIgnoreCase) ? "text-dark" : null;
        }
    }
}
